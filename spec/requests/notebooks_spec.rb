...
RSpec.describe "/notebooks", type: :request do
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Notebook" do
        expect {
          post notebooks_url,
               params: { notebook: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Notebook" do
        expect {
          post notebooks_url,
               params: { notebook: invalid_attributes }, as: :json
        }.to change(Notebook, :count).by(0)
      end

      it "renders a JSON response with errors for the new notebook" do
        post notebooks_url,
             params: { notebook: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested notebook" do
      notebook = Notebook.create! valid_attributes
      expect {
        delete notebook_url(notebook), headers: valid_headers, as: :json
      }.to change(Notebook, :count).by(-1)
    end
  end
end
