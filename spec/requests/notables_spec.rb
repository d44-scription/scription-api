...
RSpec.describe '/notebooks/:id/notables', type: :request do
  ...
  describe 'GET /show' do
    it 'renders a successful response when note is linked to given notebook' do
      get notebook_notable_url(notebook_1, item_1), as: :json
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      it 'updates the requested note' do
        expect do
          patch notebook_notable_url(notebook_1, item_1),
  ...
  describe 'DELETE /destroy' do
    it 'destroys only the requested note' do
      expect do
        delete notebook_notable_url(notebook_1, item_1), headers: valid_headers, as: :json
